...
namespace Test.StatisticalTest
{
    public class Combined5x2FTest : ClassifierTest
    {
        ...
        public void TestCompare()
        {
            ...
            Assert.AreEqual(0.535, combined5x2F.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
            ...
            Assert.AreEqual(0.0448, combined5x2F.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.0001);
            ...
            Assert.AreEqual(0.0021, combined5x2F.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.0001);
            ...
            Assert.AreEqual(0.836, combined5x2F.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
            experimentPerformance1 =
            ...
            Assert.AreEqual(0.281, combined5x2F.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
        }
    }
}