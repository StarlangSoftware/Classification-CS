...
namespace Test.StatisticalTest
{
    public class Combined5x2tTest : ClassifierTest
    {
        ...
        public void TestCompare()
        {
            ...
            Assert.AreEqual(0.962, combined5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
            ...
            Assert.AreEqual(0.038, combined5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
            ...
            Assert.AreEqual(0.9994, combined5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.0001);
            ...
            Assert.AreEqual(0.5096, combined5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.0001);
            experimentPerformance1 =
            ...
            Assert.AreEqual(0.008, combined5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
        }
    }
}