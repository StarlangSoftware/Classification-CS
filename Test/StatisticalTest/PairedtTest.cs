...
namespace Test.StatisticalTest
{
    public class PairedtTest : ClassifierTest
    {
        ...
        public void TestCompare()
        {
            ...
            Assert.AreEqual(0.945, pairedt.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.001);
            ...
            Assert.AreEqual(0.699, pairedt.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
            ...
            Assert.AreEqual(0.6058, pairedt.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.0001);
            ...
            Assert.AreEqual(0.00000025, pairedt.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.0000001);
            experimentPerformance1 = kFoldRun.Execute(new Classification.Experiment.Experiment(new NaiveBayes(), new Parameter(1), car));
            experimentPerformance2 = kFoldRun.Execute(new Classification.Experiment.Experiment(new Bagging(), new BaggingParameter(1, 50), car));
            Assert.AreEqual(0.0031, pairedt.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.0001);
            experimentPerformance1 =
                kFoldRun.Execute(new Classification.Experiment.Experiment(new Knn(), new KnnParameter(1, 3, new EuclidianDistance()), bupa));
            experimentPerformance2 = kFoldRun.Execute(new Classification.Experiment.Experiment(new Lda(), new Parameter(1), bupa));
            Assert.AreEqual(0.4735, pairedt.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.0001);
        }
    }
}