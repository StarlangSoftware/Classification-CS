...
namespace Test.StatisticalTest
{
    public class Paired5x2tTest : ClassifierTest
    {
        ...
        public void TestCompare()
        {
            ...
            Assert.AreEqual(0.963, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.001);
            ...
            Assert.AreEqual(0.00238, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.00001);
            ...
            Assert.AreEqual(0.454, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
            ...
            Assert.AreEqual(0.0, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.0001);
            ...
            Assert.AreEqual(0.0078, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.0001);
            experimentPerformance1 =
            ...
            Assert.AreEqual(0.035, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.001);
        }
    }
}