...
namespace Test.StatisticalTest
{
    public class Paired5x2tTest : ClassifierTest
    {
        ...
        public void TestCompare()
        {
            ...
            Assert.AreEqual(0.329, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(), 0.001);
            ...
            Assert.AreEqual(0.00159, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.00001);
            ...
            Assert.AreEqual(0.769, paired5x2t.Compare(experimentPerformance1, experimentPerformance2).GetPValue(),
                0.001);
